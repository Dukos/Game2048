...
public class WallOrientationFactoryTest {
	...
	public void forLeftCommand_noAdditionalSetup_createsCorrectWallOrientation() {
		...
		PointIteratorsCreator groupIterator = wallOrientation
				.getLineSelectorIteratorsCreator();
		PointIteratorsCreator lineIterator = wallOrientation
				.getLineIteratorsCreator();
