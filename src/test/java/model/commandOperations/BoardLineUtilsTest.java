...
public class BoardLineUtilsTest {
	...
	public void swapValues_twoDifferentPointsWithDifferentValues_valuesAreSwapped() {
		when(area.getFieldValue(fixedValue1.row, fixedValue1.column))
				.thenReturn(fixedValue1.value);
		when(area.getFieldValue(fixedValue2.row, fixedValue2.column))
				.thenReturn(fixedValue2.value);

		final Point p1 = new Point(fixedValue1.row, fixedValue1.column);
		final Point p2 = new Point(fixedValue2.row, fixedValue2.column);

		testObject.swapValues(p1, p2);

		verify(area).setFieldValue(fixedValue1.row, fixedValue1.column,
				fixedValue2.value);
		verify(area).setFieldValue(fixedValue2.row, fixedValue2.column,
				fixedValue1.value);
	}
