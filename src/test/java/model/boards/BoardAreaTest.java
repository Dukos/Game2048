...
public class BoardAreaTest {
	...
	public void getFieldValue_noSetup_returnsZero() {
		final int sampleValue = testObject.getFieldValue(SAMPLE_CORRECT_X, SAMPLE_CORRECT_Y);
		assertEquals(EMPTY_FIELD, sampleValue);
	}
	
	@Test
	public void setFieldValue_threePositiveValuesPassed_fieldValueChanged() {
		testObject.setFieldValue(SAMPLE_CORRECT_X, SAMPLE_CORRECT_Y, SAMPLE_CORRECT_FIELD_VALUE);
		final int fieldValue = testObject.getFieldValue(SAMPLE_CORRECT_X, SAMPLE_CORRECT_Y);
	...
	{
		testObject.setFieldValue(SAMPLE_NEGATIVE_VALUE, SAMPLE_CORRECT_Y, SAMPLE_CORRECT_FIELD_VALUE);
	}
	
	@Test(expected=IndexOutOfBoundsException.class)
	public void setFieldValue_yValueIsNegative_IndexOutOfBoundsExceptionThrown()
	{
		testObject.setFieldValue(SAMPLE_CORRECT_X, SAMPLE_NEGATIVE_VALUE, SAMPLE_CORRECT_FIELD_VALUE);
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void setFieldValue_fieldValueIsNegative_IndexOutOfBoundsExceptionThrown()
	{
		testObject.setFieldValue(SAMPLE_CORRECT_X, SAMPLE_CORRECT_Y, SAMPLE_NEGATIVE_VALUE);
	}
	...
	public void setFieldValue_xValueIsEqualWidth_IndexOutOfBoundsExceptionThrown()
	{
		...
		testObject.setFieldValue(tooBigValue, SAMPLE_CORRECT_Y, SAMPLE_CORRECT_FIELD_VALUE);
	}
	...
	public void setFieldValue_yValueIsEqualHeight_IndexOutOfBoundsExceptionThrown()
	{
		...
		testObject.setFieldValue(SAMPLE_CORRECT_X, tooBigValue, SAMPLE_CORRECT_FIELD_VALUE);
	}
